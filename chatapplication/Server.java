...
public class Server implements ActionListener{
	...
	Server(){
		...
		ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("icons/1.png"));//Here image is blank with particular width and height
		...
		// Add this to your Server constructor after adding the profile JLabel
		...
		profile.addMouseListener(new MouseAdapter() {
		    ...
		    public void mouseClicked(MouseEvent e) {
		        ...
		        ImageIcon enlargedIcon = new ImageIcon(ClassLoader.getSystemResource("icons/1.png"));
		...
		// Inside the Server constructor, after adding the phone JLabel
		...
		JLabel name=new JLabel("Nisarga");
	...
	private void checkForReminder(String msg) {
    ...
    private void scheduleReminder(String hour, String minute, String reminderMessage) {
   ...
   public static void main(String[] args) throws IOException {
	   ...
	   try (ServerSocket skt = new ServerSocket(61075)) {
		   
		   //To accept all the msgs
		   while(true) {
			   Socket s=skt.accept();//storing the accepted msgs in Socket s
			   //To receive the msg
